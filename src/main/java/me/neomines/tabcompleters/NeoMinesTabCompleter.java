package me.neomines.tabcompleters;
...
public class NeoMinesTabCompleter implements TabCompleter {

    private final ArrayList<String> materials;

    public NeoMinesTabCompleter() {
            ...
            case 3: {
                ...
                switch (args[0].toLowerCase()) {
                    ...
                    case "unset":
                        ...
                        MineManager.getInstance().getMine(args[1]).getBlocks().forEach(block -> blockList.add(block.getBlockData().getMaterial().name().toLowerCase()));
