...
public abstract class PaginatedMenu extends Menu {
    ...
    public void addMenuBorder() {
        ...
        inventory.setItem(48, ItemStackBuilder.buildItem(Material.ARROW,
                plugin.getLangString("GUI.Universal.Previous-Page.Name"),
                plugin.getLangStringList("GUI.Universal.Previous-Page.Lore")));

        inventory.setItem(49, ItemStackBuilder.buildItem(Material.BARRIER,
                plugin.getLangString("GUI.Universal.Close.Name"),
                plugin.getLangStringList("GUI.Universal.Close.Lore")));

        inventory.setItem(50, ItemStackBuilder.buildItem(Material.ARROW,
                plugin.getLangString("GUI.Universal.Next-Page.Name"),
                plugin.getLangStringList("GUI.Universal.Next-Page.Lore")));
